...
namespace SISniPIAL {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentRow AddstudentRow(string FirstName, string LastName, System.DateTime DateOfBirth, string Gender, string Email, string Phone, string Address, System.DateTime EnrollmentDate, string Status, int userId) {
            ...
            public int userId {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'userId\' in table \'student\' is DBNull.", e);
                    }
                }
                set {
...
namespace SISniPIAL.StudentDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[student] ([FirstName], [LastName], [DateOfBirth], [Gender], [Email], [Phone], [Address], [EnrollmentDate], [Status], [userId]) VALUES (@FirstName, @LastName, @DateOfBirth, @Gender, @Email, @Phone, @Address, @EnrollmentDate, @Status, @userId);
SELECT StudentId, FirstName, LastName, DateOfBirth, Gender, Email, Phone, Address, EnrollmentDate, Status, userId FROM student WHERE (StudentId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [FirstName] = @FirstName, [LastName] = @LastName, [DateOfBirth] = @DateOfBirth, [Gender] = @Gender, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [EnrollmentDate] = @EnrollmentDate, [Status] = @Status, [userId] = @userId WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_DateOfBirth = 1 AND [DateOfBirth] IS NULL) OR ([DateOfBirth] = @Original_DateOfBirth)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_EnrollmentDate = 1 AND [EnrollmentDate] IS NULL) OR ([EnrollmentDate] = @Original_EnrollmentDate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_userId = 1 AND [userId] IS NULL) OR ([userId] = @Original_userId)));
SELECT StudentId, FirstName, LastName, DateOfBirth, Gender, Email, Phone, Address, EnrollmentDate, Status, userId FROM student WHERE (StudentId = @StudentId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FirstName, LastName, DateOfBirth, Gender, Email, Phone, Address" +
                ", EnrollmentDate, Status, userId FROM dbo.student";
        ...
        public virtual int Delete(int Original_StudentId, string Original_FirstName, string Original_LastName, global::System.Nullable<global::System.DateTime> Original_DateOfBirth, string Original_Gender, string Original_Email, string Original_Phone, string Original_Address, global::System.Nullable<global::System.DateTime> Original_EnrollmentDate, string Original_Status, global::System.Nullable<int> Original_userId) {
            ...
            if ((Original_EnrollmentDate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((System.DateTime)(Original_EnrollmentDate.Value));
            }
            else {
        ...
        public virtual int Insert(string FirstName, string LastName, global::System.Nullable<global::System.DateTime> DateOfBirth, string Gender, string Email, string Phone, string Address, global::System.Nullable<global::System.DateTime> EnrollmentDate, string Status, global::System.Nullable<int> userId) {
            if ((FirstName == null)) {
            ...
            if ((EnrollmentDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[7].Value = ((System.DateTime)(EnrollmentDate.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((EnrollmentDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(EnrollmentDate.Value));
            }
            else {
            ...
            if ((Original_EnrollmentDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((System.DateTime)(Original_EnrollmentDate.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    string Original_Status, 
                    global::System.Nullable<int> Original_userId) {
            return this.Update(FirstName, LastName, DateOfBirth, Gender, Email, Phone, Address, EnrollmentDate, Status, userId, Original_StudentId, Original_FirstName, Original_LastName, Original_DateOfBirth, Original_Gender, Original_Email, Original_Phone, Original_Address, Original_EnrollmentDate, Original_Status, Original_userId, Original_StudentId);
        }
    }
